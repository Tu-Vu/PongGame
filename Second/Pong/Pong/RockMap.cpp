...
void RockMap::Initialize(RenderWindow* window) {
	...
	this->Rock1->SetBall(this->BallObject); // cho máy ball cần chơi

	this->Rock2 = new PaddleAI(2);
	this->Rock2->SetBall(this->BallObject); // cho máy ball cần chơi

	this->Rock3 = new PaddleAI(2);
	this->Rock3->SetBall(this->BallObject); // cho máy ball cần chơi
